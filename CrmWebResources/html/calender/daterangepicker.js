...
(function (root, factory) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (typeof options.locale === 'object') {
            ...
            if (typeof options.locale.applyLabel === 'string')
                this.locale.rentedLabel = options.locale.rentedLabel;
        ...
        this.container.find('.drp-buttons')
            ...
            .on('click.daterangepicker', 'button.rentedBtn', $.proxy(this.clickRented, this));;
    ...
    DateRangePicker.prototype = {
        ...
        updateFormInputs: function () {
            ...
            */
            if (this.singleDatePicker || (this.endDate && (this.startDate.isBefore(this.endDate) || this.startDate.isSame(this.endDate)))) {
                ...
                this.container.find('button.cancelBtn').prop('disabled', false);
            } else {
        ...
        clickRented: function (e) {
            if (!this.endDate) {
                this.startDate = this.oldStartDate.clone();
                this.endDate = this.oldEndDate.clone();
            }
            this.element.trigger('rented.daterangepicker', this);
        },
